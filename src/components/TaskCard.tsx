...
function TaskCard({ task, deleteTask, updateTask }: Props) {
	...
	if (isDragging) {
		return (
			<div
				ref={setNodeRef}
				style={style}
				className="relative flex h-[80px] min-h-[80px] cursor-grab items-center rounded-xl border-2 border-rose-500 bg-mainBgColor p-2.5 text-left opacity-30"
			/>
		);
	}
	...
	return (
		<div
			...
			className="task relative flex h-[80px] min-h-[80px] cursor-grab items-center rounded-xl bg-mainBgColor p-2.5 text-left hover:ring-2 hover:ring-inset hover:ring-rose-500"
		>
